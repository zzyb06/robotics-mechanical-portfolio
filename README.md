...
主修课程：机械原理、机械设计、理论力学、材料力学、互换性与技术测量、机电传动控制。
...
| 主要动作 | 对应机械模块 | 后续需要补充 |
| --- | --- | --- |
| 矛杆抓取与 R2 对接 | 气动爪、连杆驱动和底盘移动 | 抓取、杆子变水平和对接接口截图 |
| 通过梅林 R1 过道 | 纵梁式麦克纳姆轮底盘 | 已补充底盘装配图；后续补充通道空间截图 |
| KFS 多高度抓取与第一层放置 | 塔吊式机械臂、末端吸盘和气泵 | 已补充机械臂装配图；后续补充吸取和释放截图 |
| 协同举升 R2 | 剪叉式抬升机构 | 已补充抬升平台图；后续补充完整剪叉动作和 R2 承托截图 |
...
各模块的具体比赛任务、尺寸参数和最终性能将在补充截图与实测资料后完善。
...
- [x] 完成作品集仓库框架
- [x] 完成项目文字初稿
- [x] 配置原始 CAD 和申报材料忽略规则
- [x] 补充 R1 整机总装图
- [x] 补充气动爪、底盘、机械臂和抬升模块展示图
- [ ] 补充项目尺寸、重量和实测数据
- [x] 补充比赛视频
- [x] 发布到 GitHub
